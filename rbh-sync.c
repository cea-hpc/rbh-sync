...
usage(void)
{
    const char *message =
        ...
        "    [x] size        [x] atime.nsec  [x] atime.sec   [x] btime.nsec\n"
        "    [x] btime.sec   [x] ctime.nsec  [x] ctime.sec   [x] mtime.nsec\n"
        "    [x] mtime.sec   [x] rdev.major  [x] rdev.minor  [x] dev.major\n"
        "    [x] dev.minor   [ ] mount-id\n"
        "\n"
